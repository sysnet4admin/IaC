...
| `Dockerfile.llama32-3b` | ollama/ollama:0.30.6 | llama3.2:3b | 12GB 워커 MoA(Meta) |
| `Dockerfile.gemma4-e2b` | ollama/ollama:0.30.6 | gemma4:e2b-it-qat | 12GB 워커 MoA(Google) |
| `Dockerfile.gemma4-e4b` | ollama/ollama:0.30.6 | gemma4:e4b-it-qat | gemma4 QAT(Google) |
| `Dockerfile.gemma4-12b` | ollama/ollama:0.30.6 | gemma4:12b-it-qat | gemma4 QAT(Google) |
| `Dockerfile.gemma4-26b-a4b` | ollama/ollama:0.30.6 | gemma4:26b-a4b-it-qat | gemma4 QAT MoE(Google) |
| `Dockerfile.gemma4-31b` | ollama/ollama:0.30.6 | gemma4:31b-it-qat | gemma4 QAT(Google) |
